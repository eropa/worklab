...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Весь товар</h1>
    </div>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    @guest
                    @else
                        <a class="btn btn-primary" href="{{ url('tovar/create') }}" role="button">Добавить</a>
                    @endguest
                        ...
                        <table class="table">
                            ...
                            @foreach($datas as $data)
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-primary"  href="{{ url('/tovar/'.$data->id) }}">
                                            Просмотреть
                                        ...
                                        @else
                                            /
                                            <a class="btn btn-primary" href="{{ url('tovar/'.$data->id.'/edit ') }}" role="button">
                                                Редактировтаь</a>
                                            /
                                            <a class="btn btn-primary"
                                               href="#{{$data->id}}"
                                               onclick="event.preventDefault();
                                                    document.getElementById('delet-form').action = '/tovar/{{$data->id}}';
